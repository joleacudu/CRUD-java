...
public class CrearServlet extends HttpServlet {
	...
	protected void crearUsuario(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//String botonCrear = request.getParameter("boton_crea");
		...
		boolean existeUsuario = logica.crearUsuario(dto);
		if(existeUsuario) {
	...
	protected void crearCliente(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean existeCliente = logica.crearCliente(dto);
		if(existeCliente) {
			response.sendRedirect("/tienda_generica/menu/menu.jsp");
		}
	}
	
	protected void crearProveedor(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub		
